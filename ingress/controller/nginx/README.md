...
```
kubectl apply -f ./ingress/controller/nginx/features/service-a.yaml
kubectl apply -f ./ingress/controller/nginx/features/service-b.yaml
```
...
```
kubectl apply -f ./ingress/controller/nginx/features/routing-by-domain.yaml
```
...
```
kubectl apply -f ./ingress/controller/nginx/features/routing-by-path.yaml
```
...
```
kubectl apply -f ./ingress/controller/nginx/features/basic-auth.yaml
```
